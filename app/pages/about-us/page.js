    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center">
          <span className="inline-block bg-blue-100 text-blue-600 px-4 py-1 rounded-full text-sm font-medium mb-4">About Rentahan</span>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-500">
            Rentahan makes property management effortless for landlords and creates 
          ...
          <div className="p-8 sm:p-10 lg:p-12 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                At Rentahan, we're dedicated to providing top-tier property management solutions that
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">What Makes Rentahan Different</h2>
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Unlike other platforms, Rentahan is designed with both landlords and tenants in mind,
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Rentahan uses innovative technology to automate tedious tasks, generate insights,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">The Rentahan Story</h2>
          <p className="text-gray-600 mb-4">
              Rentahan was founded by a group of Benildean Information Systems (IS) students as part of their thesis project. 
          ...
          <p className="text-gray-600">
              ...
              Rentahan is designed to bridge the gap between landlords and tenants by providing a streamlined, user-friendly platform 
      ...
      <div className="bg-blue-600 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join the Rentahan community and discover a better way to manage properties.
          </p>
