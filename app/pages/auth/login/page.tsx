              ...
              <div className="relative z-20 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
                <div className="max-w-md mx-auto">
                  ...
                  <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-lg mb-4 lg:bg-transparent lg:shadow-none">
                      <Image
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-700 to-emerald-600 bg-clip-text text-transparent mb-2">
                      Welcome Back
                    </h2>
                    <p className="text-blue-200 lg:text-gray-600 text-sm">
                      Sign in to access your account
                    </p>
                  </div>

                  {/* Form Card */}
                  <div className="bg-white/95 lg:bg-white backdrop-blur-sm rounded-2xl shadow-xl lg:shadow-lg p-4 sm:p-6 border border-white/20 lg:border-gray-200">
                    <form
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                              ...
                              id="email"
                              autoComplete="email"
                              className={`w-full px-3 py-2 border-2 rounded-xl transition-all duration-200 bg-white text-sm
                            ${
                                  focusedField === "email"
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                              ...
                              className={`w-full px-3 py-2 pr-10 border-2 rounded-xl transition-all duration-200 bg-white text-sm
                            ${
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <label className="flex items-center">
                          <input
                              ...
                              className="w-3 h-3 text-blue-600 bg-white border-2 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                              disabled={isLoggingIn}
                          />
                      ...
                      <button
                          ...
                          className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 disabled:from-blue-400 disabled:to-emerald-400 text-white font-semibold py-2 px-4 rounded-xl transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl disabled:cursor-not-allowed disabled:shadow-md transform hover:scale-[1.02] disabled:transform-none text-sm"
                      >
                        {isLoggingIn ? (
                            <>
                              <svg
                      ...
                      <button
                          ...
                          disabled={isLoggingIn}
                          className="w-full bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-medium py-2 px-4 rounded-xl transition-all duration-200 flex items-center justify-center hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md text-sm"
                      >
