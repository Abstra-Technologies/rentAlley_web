...
export default function CreateAnnouncement() {
  ...
  useEffect(() => {
    async function fetchProperties() {
      try {
        ...
        const response = await fetch(`/api/landlord/announcement/fetchPropertyLists?landlord_id=${user.landlord_id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/landlord/announcement/createAnnouncement", {
        method: "POST",
