            ...
            {step === 1 && (
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 text-sm mb-6 text-center">
                        You can either upload an existing signed document or generate a new
                        one using UpKyp's guided system.
                    </p>

                    <div
                        id="mode-selection"
                        className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl mb-8"
                    >
                        {/* Upload Option */}
                        <div
                            id="upload-option"
                ...
                >
                    ...
                    >
                        <h3 className="text-md font-semibold text-gray-800 mb-3 flex items-center gap-2">
                            <ClipboardList className="w-4 h-4 text-blue-600" /> Tenant & Lease
                            Information
                        </h3>
                        {leaseDetails ? (
