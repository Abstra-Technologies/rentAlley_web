    ...
    const menu = [
        {
            ...
            icon: Home,
            description: "Manage available spaces",
        },
        {
            id: "active-lease",
            label: "Active Lease",
        ...
        },
        {
            ...
            icon: CreditCard,
            description: "Handle rent and utilities",
        },
        {
            id: "pdc-management",
            ...
            icon: FileText,
            description: "Track post-dated checks",
        },
        {
            id: "Prospectives",
            label: "Prospectives",
        ...
        },
        {
            ...
            icon: Zap,
            description: "Monitor sub-meter rates",
        },
        {
            id: "configuration",
            label: "Configuration",
            ...
            description: "Edit property settings",
        },
    ];
