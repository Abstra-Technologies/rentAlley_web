...
export default function FinancialsPage() {
  ...
  const { data, error, isLoading } = useSWR(
    `/api/analytics/landlord/revenue-expense-trend?property=${selectedProperty}&year=${selectedYear}`,
    fetcher
  );
  ...
  return (
      <div className="min-h-screen p-5 bg-gray-50">
        ...
        <p className="text-gray-500 text-sm">
          Note: Data is real-time; values may update based on access time.
        </p>
