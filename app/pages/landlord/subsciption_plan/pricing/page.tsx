...
export default function SubscriptionPlans() {
    ...
    const handleProceed = async () => {
        ...
        try {
            ...
            // 💳 PAID PLAN (NO FREE TRIAL)
            else {
                let amountToCharge;

                if (!currentSubscription && trialUsed) {
                    // No active plan + trial used → full charge
                    amountToCharge = selectedPlan.price;
                } else {
                    // Active plan → prorated
                    amountToCharge = proratedAmount;
                }

                // 🔹 Direct Maya Gateway Payment (skip checkout page)
                try {
                    ...
                    if (response.data.checkoutUrl) {
                        // 🟢 Direct redirect to Maya Gateway
                    ...
                    Swal.fire({
                        ...
                        text: "Unable to proceed to payment. Please try again.",
                    });
                }
            }
        } catch (error) {
