            ...
            <main className="flex-1 p-4 sm:p-6 lg:p-10">
                <div className="max-w-6xl mx-auto space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 max-w-md">
                                    Manage your plan, review policies, and view your billing history.
                                </p>
                            </div>
                    ...
                    <section className="bg-white rounded-2xl shadow-sm border border-gray-200">
                        ...
                        <div className="p-6">
                            <LandlordPastSubscriptionsComponent landlord_id={user?.landlord_id} />
                        </div>
                    </section>
                </div>
            </main>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 relative animate-fadeIn">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                            <ScrollText className="w-6 h-6 text-blue-600" /> Subscription Policies
                        </h2>
                        ...
                        <div className="text-gray-700 space-y-4 text-sm leading-relaxed">
                            {activeTab === "upgrade" && (
                                <>
                                    <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                                        <Sparkles className="text-green-600 w-5 h-5" /> Upgrade Policy
                                    </h3>
                                    <p>
                                        UpKyp offers a flexible upgrade policy for subscription plans. If you
                                        choose to upgrade before your billing cycle ends, the additional cost
                                        will be pro-rated based on remaining days, so you only pay for what you
                                        use.
                                    </p>
                                </>
                            )}
                            ...
                            {activeTab === "trial" && (
                                <>
                                    <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                                        <ShieldCheck className="text-blue-600 w-5 h-5" /> Free Trial Policy
                                    </h3>
                                    <p>
                                        Each landlord is eligible for one free trial. If you’ve already used a
                                        trial, you’ll need to subscribe to continue. No payment details are
                                        required during your first trial period.
                                    </p>
                                </>
                            )}
                            ...
                            {activeTab === "refund" && (
                                <>
                                    <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                                        <CreditCard className="text-red-600 w-5 h-5" /> Refund Policy
                                    </h3>
                                    <p>
                                        UpKyp does not offer refunds after payment has been processed. Please
                                        review your selected plan before confirming your purchase.
                                    </p>
                                </>
                            )}
                        </div>
