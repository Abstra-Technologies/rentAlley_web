                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="25"
                        className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 sm:pr-12 border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-gray-50 focus:bg-white text-sm sm:text-base"
                      />
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-gray-700">
                          Bed Spacing Available
                        </label>
                        <p className="text-xs text-gray-500 mt-1">
                          Check if this unit offers individual bed rentals
                        </p>
                      </div>
                    </div>
                    ...
                    {formData.bedSpacing && (
                      <div className="ml-6 sm:ml-8 space-y-2">
                        ...
                        <input
                          ...
                          placeholder="4"
                          min={0}
                          className="w-24 sm:w-32 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base"
                        />
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-gray-50 rounded-lg sm:rounded-xl p-4 sm:p-6 space-y-3 sm:space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Tenant must provide security deposit before moving in
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Tenant must pay rent in advance
                      </p>
                    </div>
                  </div>
                </div>
