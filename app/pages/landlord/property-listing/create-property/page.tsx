...
export default function AddNewProperty() {
  ...
  // Initialize onboarding for each step
      ...
      <div className="bg-white rounded-xl shadow-sm border p-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            onClick={prevStep}
            className="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div>
          {step === 1 ? (
            <button
              onClick={nextStep}
              disabled={submitting}
              className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {submitting ? (
                <>
