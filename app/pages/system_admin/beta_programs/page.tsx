...
export default function BetaProgramsPage() {
    ...
    const handleApprove = async (applicant: any) => {
        ...
        await axios.patch(
            "/api/systemadmin/beta-program/decision/approve",
            {
                beta_id: applicant.beta_id,
                landlord_id: applicant.landlord_id, // 👈 landlord being approved
                admin_id: admin.admin_id,             // 👈 admin performing action
            }
        );
    ...
    const handleReject = async (applicant: any) => {
        ...
        await axios.patch(
            "/api/systemadmin/beta-program/decision/reject",
            {
                beta_id: applicant.beta_id,
                    ...
                    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                        <div className="bg-white rounded-xl w-full max-w-lg p-6">
                            <h2 className="text-lg font-bold mb-4">
                                Beta Applicant Details
                            </h2>

                            <ul className="space-y-2 text-sm">
                                <li><strong>Name:</strong> {selectedApplicant.full_name}</li>
                                <li><strong>Email:</strong> {selectedApplicant.email}</li>
                                <li><strong>Landlord ID:</strong> {selectedApplicant.landlord_id}</li>
                                <li><strong>Region:</strong> {selectedApplicant.region}</li>
                                <li><strong>City:</strong> {selectedApplicant.city}</li>
                                <li><strong>Properties:</strong> {selectedApplicant.properties_count}</li>
                                <li><strong>Avg Units / Property:</strong> {selectedApplicant.avg_units_per_property}</li>
                                <li><strong>Status:</strong> {selectedApplicant.status}</li>
                            </ul>
