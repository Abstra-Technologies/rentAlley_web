...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  try {
    const res = await fetch(`${baseUrl}/api/properties/findRent/viewPropUnitDetails?rentId=${rentId}`, {
    ...
    const description = `Rent this unit for ₱${Number(unit.rent_amount).toLocaleString()} per month in ${unit.city}, ${unit.province}.`;
