...
/**
 * @method      GET
 * @route      app/api/landlord/billing/submetered/getUnitBilling
 * @desc        Fetch all unit specific data includieng meter readings, rental info.
 * @usedIn      app/pages/landlord/properties/[id]/billing/createUnitBill/[unit_id]/page.tsx
 * @returns     JSON list of all unit data info.
 */
...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        // 🔹 2.5) Fetch rent_amount from LeaseAgreement (fallback to Unit)
        ...
        `,
            ...
            console.warn("⚠️ Lease rent lookup failed:", e);
        }
        ...
        // ✅ Added rent fallback to response
        return NextResponse.json(
            {
                unit: {
                    ...unit,
                    effective_rent_amount: effectiveRentAmount, // ✅ unified rent value
                },
                property,
