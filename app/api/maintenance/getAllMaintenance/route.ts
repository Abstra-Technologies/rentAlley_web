...
export async function GET(req: NextRequest) {
    ...
    try {
      ...
      SELECT 
        ...
        mr.description,
        mr.category,
        mr.priority_level,         -- 🆕 Include priority level
        mr.status,
        mr.created_at,
      ...
      GROUP BY 
        ...
        description,
        category,
        priority_level,           -- 🆕 Include in GROUP BY
        status,
        created_at
    `;
        ...
        const decryptedRequests = (requests as any[]).map((req) => {
            ...
            return {
                ...
                priority_level: req.priority_level || "Medium", // 🆕 Default if null
            };
        });
