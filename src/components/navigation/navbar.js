            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                                        ...
                                        <div className="max-h-96 overflow-y-auto">
                                            {notifications.length === 0 ? (
                                                ...
                                                notifications.map((notif) => (
                                                    <div key={notif.id} className="border-b hover:bg-gray-50 cursor-pointer transition-colors duration-200">
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                >
                                    ...
                                    <div className="hidden lg:block">
                                        <div className="text-sm font-medium leading-none">{user?.firstName || admin?.firstName || "User"}</div>
                                        <div className="text-xs text-blue-100">{user?.userType || "Admin"}</div>
                                    </div>
                                    <svg 
                                ...
                                {dropdownOpen && (
                                    <div className="absolute right-0 top-12 w-56 bg-white text-black rounded-lg shadow-xl py-2 z-10 transition-all duration-300 transform origin-top-right">
                                        <div className="px-4 py-2 border-b border-gray-100">
                                            <p className="text-sm font-semibold text-gray-900">{user?.firstName || admin?.firstName || "User"}</p>
                                            <p className="text-xs text-gray-500">{user?.email || admin?.email || ""}</p>
                                        </div>
                                        ...
                                        <Link href="/settings" className="flex items-center px-4 py-2 hover:bg-gray-100 transition-colors duration-200">
                                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="md:hidden flex items-center space-x-2">
                        ...
                        >
                            <svg className={`w-6 h-6 transition-transform duration-300 ${menuOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {!user && !admin ? (
                        ...
                        <div className="flex flex-col space-y-1 pt-2 border-t border-blue-500">
                            <div className="flex items-center space-x-3 px-3 py-2">
                                ...
                                />
                                <div>
                                    <div className="font-medium">{user?.firstName || admin?.firstName || "User"}</div>
                                    <div className="text-xs text-blue-100">{user?.email || admin?.email || ""}</div>
                                </div>
                            </div>
