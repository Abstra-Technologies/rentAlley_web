    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen">
          ...
          <div className="md:hidden p-4 bg-white shadow-sm flex justify-between items-center">
            ...
            <button onClick={toggleMobileMenu} className="p-2 rounded-lg text-gray-700 hover:bg-gray-100">
          ...
          {/* Sidebar */}
          <div
              className={`${isMobileMenuOpen ? "block" : "hidden"} md:block w-full md:w-64 bg-white shadow-lg md:min-h-screen`}>
