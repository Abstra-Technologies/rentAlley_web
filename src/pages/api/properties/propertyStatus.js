...
//         });
//
//         // ✅ Retrieve current status, rejection attempts, and user's FCM token from Users table
//         const [rows] = await connection.execute(
//             `SELECT pv.status, pv.attempts, u.fcm_token
...
//         }
//
//         const { status: currentStatus, attempts, fcm_token, user_id } = rows[0];
...
//             'INSERT INTO Notification (user_id, title, body, is_read) VALUES (?,?,?, 0)',
//             [validUserId, notificationTitle, notificationBody],
//         )
//
//         if (fcm_token) {
