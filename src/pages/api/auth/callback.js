...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("Processed Google OAuth Data:", {
      googleId,
      firstName,
      lastName,
      email,
    ...
    if (existingUsers.length > 0) {
      return res.redirect(
        `/pages/auth/register?error=${encodeURIComponent(
