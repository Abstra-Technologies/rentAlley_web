...
import {encryptEmail, encryptFName, encryptLName, encryptPhone} from "../../crypto/encrypt";
    ...
    if (req.method === "POST") {
        ...
        try {
            ...
            if (existingUser.length > 0) {
                return res.status(409).json({ error: "User with this email already exists, Please Signin instead." });
            }
