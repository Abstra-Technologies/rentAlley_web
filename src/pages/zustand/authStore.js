...
//         try {
//             const encryptionKey2 = process.env.ENCRYPTION_SECRET;
//             if (!encryptionKey2) {
//                 console.error("Missing ENCRYPTION_SECRET in environment variables.");
//                 return data;
//             }
...
//                     first_name: decryptData(JSON.parse(data.first_name), encryptionKey2),
//                     last_name: decryptData(JSON.parse(data.last_name), encryptionKey2),
//                     email: decryptData(JSON.parse(data.email), encryptionKey2),
//                     role: data.role,
//                     status: data.status,
//                 //     profilePicture: data.profilePicture,
//             };
