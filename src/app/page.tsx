      ...
      <div className="relative h-[500px]">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-white">
          ...
          <form 
            ...
            className="bg-white rounded-lg p-2 md:p-3 shadow-lg flex flex-col md:flex-row gap-2 w-full max-w-4xl"
          >
            {/* Location Dropdown */}
            <div className="relative md:w-1/4">
              <button
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-left flex justify-between items-center"
              >
                <span className={selectedLocation ? "text-gray-800" : "text-gray-400"}>
                  {selectedLocation || "Location"}
                </span>
                <FaChevronDown className={`transition duration-300 ${showLocationDropdown ? "rotate-180" : ""} text-gray-400`} />
              </button>
            ...
            <div className="relative md:w-1/4">
              ...
              >
                <span className={selectedType ? "text-gray-800" : "text-gray-400"}>
                  {selectedType || "Residential Type"}
                </span>
                <FaChevronDown className={`transition duration-300 ${showTypeDropdown ? "rotate-180" : ""} text-gray-400`} />
              </button>
            ...
            <div className="flex-1">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg outline-none focus:border-blue-500 transition-colors"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 transition-colors text-white px-6 py-3 rounded-lg flex items-center justify-center"
            >
