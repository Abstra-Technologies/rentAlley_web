    ...
    if (error) {
        return (
            <div className="max-w-3xl mx-auto mt-10 p-6 bg-red-50 border border-red-200 rounded-lg">
                ...
                <button 
                    onClick={() => router.push('/pages/system_admin/propertyManagement/list')}
            ...
            <div className="flex-1 bg-gray-50 min-h-screen pb-12">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">Property ID: {property.property_id}</p>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="bg-white shadow rounded-lg overflow-hidden">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex">
                                                <span className="w-32 text-sm font-medium text-gray-500">City:</span>
                                                <span className="text-sm text-gray-900">{property.city}</span>
                                            </div>
                                            <div className="flex">
                                                <span className="w-32 text-sm font-medium text-gray-500">Barangay:</span>
                                                <span className="text-sm text-gray-900">{property.brgy_district}</span>
                                            </div>
                                            <div className="flex">
                                                <span className="w-32 text-sm font-medium text-gray-500">ZIP Code:</span>
                                                <span className="text-sm text-gray-900">{property.zip_code}</span>
                                            </div>
                                            <div className="flex">
                                                <span className="w-32 text-sm font-medium text-gray-500">Province:</span>
                                                <span className="text-sm text-gray-900">{property.province}</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {property.admin_id && (
                                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-3">
                                                <h3 className="text-sm font-medium text-blue-800">Administrative Information</h3>
                                                <div className="mt-2 text-sm text-blue-700">
                                                    <p>Last Updated by Admin: {property.admin_id}</p>
                                                    {property.admin_message && (
                                                        <p className="mt-1">Admin Message: {property.admin_message}</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {property.mayor_permit ? (
                                        <div className="border rounded-lg overflow-hidden">
                                            <div className="bg-gray-50 px-4 py-2 border-b">
                                                <h3 className="font-medium text-gray-700">Mayor's Permit</h3>
                                            </div>
                                            <div className="p-2">
                                        ...
                                        <div className="border rounded-lg overflow-hidden bg-gray-50 p-6 flex items-center justify-center">
                                            <p className="text-gray-500">No Mayor's Permit document available</p>
                                        </div>
                                    )}
                                    ...
                                    {property.occ_permit ? (
                                        <div className="border rounded-lg overflow-hidden">
                                            <div className="bg-gray-50 px-4 py-2 border-b">
                                                <h3 className="font-medium text-gray-700">Occupancy Permit</h3>
                                            </div>
                                            <div className="p-2">
                                        ...
                                        <div className="border rounded-lg overflow-hidden bg-gray-50 p-6 flex items-center justify-center">
                                            <p className="text-gray-500">No Occupancy Permit document available</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        {activeTab === "photos" && (
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div>
                                        <h3 className="font-medium text-gray-700 mb-3">Outdoor Photo</h3>
                                        {property.outdoor_photo ? (
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-gray-50 p-6 h-64 flex items-center justify-center">
                                                <p className="text-gray-500">No outdoor photo available</p>
                                            </div>
                                        )}
                                    </div>
                                    
                                    <div>
                                        <h3 className="font-medium text-gray-700 mb-3">Indoor Photo</h3>
                                        {property.indoor_photo ? (
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-gray-50 p-6 h-64 flex items-center justify-center">
                                                <p className="text-gray-500">No indoor photo available</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                
                                <h3 className="font-medium text-gray-700 mb-3">Additional Property Photos</h3>
                        ...
                        {activeTab === "approval" && (
                            <div className="p-6">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">Property Approval</h2>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                                    ...
                                    {property.admin_message && (
                                        <div className="mt-4">
                                            <h4 className="text-sm font-medium text-gray-500">Previous Admin Message:</h4>
                                ...
                                <div className="bg-white border rounded-lg p-6">
                                    <h3 className="font-medium text-gray-900 mb-4">Update Property Status</h3>
