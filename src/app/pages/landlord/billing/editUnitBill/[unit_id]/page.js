...
export default function EditUnitBill() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4 sm:p-6 bg-white rounded-xl shadow-sm">
        ...
        <>
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-end">
              <button 
                onClick={() => { calculateBill(); setStep(2); }} 
                type="button" 
      ...
      {step === 2 && (
        <>
          <h3 className="text-xl font-semibold text-gray-800 mb-4">Billing Summary</h3>
          
          <div className="rounded-lg overflow-hidden shadow-md mb-6">
            <div className="bg-blue-600 text-white py-4 px-5">
              <h4 className="font-medium text-lg">
                {new Date(bill.billing_period).toLocaleDateString("en-US", { year: "numeric", month: "long" })} Invoice
              </h4>
            </div>
            ...
            <div className="divide-y divide-gray-200">
              ...
              <div className="p-5 bg-white">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center pl-7 text-sm">
                    ...
                    <p className="font-semibold text-blue-600">₱{formData.total_water_amount}</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-medium text-gray-800">Electricity Usage</h4>
                  </div>
                  <div className="flex justify-between items-center pl-7 text-sm">
                    <p className="text-gray-600">Cost:</p>
                    <p className="font-semibold text-yellow-600">₱{formData.total_electricity_amount}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 bg-white">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-medium text-gray-800">Additional Charges</h4>
                </div>
                ...
                <div className="space-y-2 pl-7">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <p className="font-medium text-red-600">₱{formData.penalty_amount}</p>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <p className="text-gray-600">Discounts:</p>
                    <p className="font-medium text-green-600">-₱{formData.discount_amount || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 bg-gray-800 text-white">
                <div className="flex justify-between items-center">
                  ...
                  <p className="font-bold text-xl">₱{formData.total_amount_due}</p>
                </div>
              </div>
            </div>
          </div>
