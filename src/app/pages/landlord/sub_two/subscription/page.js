        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
                ...
                <p className="max-w-2xl mx-auto text-xl text-gray-500">
                    Select the subscription that best fits your property management needs
                </p>
            </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-600">
                                You are currently on the <span className="font-semibold">{currentSubscription?.plan_name}</span> plan
                            </p>
                        </div>
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-md p-6 mb-8 text-white">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-1">You're eligible for a free trial of our premium features. Select a plan to start.</p>
                        </div>
                    </div>
                </div>
            )}
                    ...
                    return (
                        <div
                            ...
                            className={`
                                ...
                                ${isCurrentPlan ? "opacity-60 cursor-not-allowed ring-2 ring-gray-300" : "cursor-pointer hover:shadow-xl transform hover:-translate-y-1"} 
                                ${isSelectedPlan ? "ring-2 ring-blue-500 shadow-lg" : "shadow-md"}
                            `}
                        >
                            {plan.popular && (
                                ...
                                {plan.trialDays > 0 && !trialUsed && (
                                    <p className="mt-4 text-sm text-blue-600 font-medium flex items-center">
                                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h8V3a1 1 0 112 0v1h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2h1V3a1 1 0 011-1zm11 14V6H4v10h12z" clipRule="evenodd"></path>
                                        </svg>
            ...
            {selectedPlan && currentSubscription && (
                <div className="bg-white rounded-lg shadow-md p-6 mb-8 border-l-4 border-green-500">
                    <div className="flex items-start">
                        ...
                        <div className="ml-4">
                            <h3 className="text-lg font-medium text-gray-900">Prorated Billing</h3>
                            <p className="mt-1 text-gray-600">
                                We'll adjust your bill to account for your current subscription. Your new total will be <span className="font-semibold text-green-600">₱{proratedAmount?.toFixed(2)}</span> after applying the discount for unused days.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-16">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden divide-y divide-gray-200">
                    <div className="p-6">
                        ...
                        <p className="mt-2 text-gray-600">Yes, you can upgrade or downgrade your plan at any time. When upgrading, we'll prorate your current subscription.</p>
                    </div>
                    <div className="p-6">
                        <h3 className="text-lg font-medium text-gray-900">Is there a long-term contract?</h3>
                        <p className="mt-2 text-gray-600">No, all plans are billed monthly and you can cancel anytime.</p>
                    </div>
                    <div className="p-6">
                        <h3 className="text-lg font-medium text-gray-900">What payment methods do you accept?</h3>
                        <p className="mt-2 text-gray-600">We only accept payments through Maya.</p>
                    </div>
                </div>
            </div>
        </div>
