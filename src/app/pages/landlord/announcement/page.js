        ...
        <div className="max-w-6xl mx-auto py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200 w-full sm:w-auto"
            >
              Create Announcement
            </button>
          </div>
          ...
          <div className="space-y-4">
            {announcements.length === 0 ? (
              ...
              announcements.map((announcement) => (
                <div key={announcement.id} className="bg-white rounded-lg shadow hover:shadow-lg transition duration-200 p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div>
                      ...
                      <h3 className="text-lg font-semibold mb-1">{announcement.subject}</h3>
                    ...
                    <Link
                      ...
                      className="p-2 hover:bg-gray-100 rounded-full transition duration-200 mt-3 sm:mt-0"
                    >
