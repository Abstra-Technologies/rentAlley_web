...
import { Home, Wrench, BarChart3, CreditCard, Sparkles } from "lucide-react";
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              How Upkyp Works
                    ...
                    <p className="text-base sm:text-lg text-gray-600 max-w-xl mx-auto leading-relaxed">
                        Upkyp is a rental listing and property management platform designed to
                        simplify operations for landlords and tenants.
                    </p>
                </div>
