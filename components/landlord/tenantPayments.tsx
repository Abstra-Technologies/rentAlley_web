...
export default function PaymentList({
    ...
    if (!payments.length) {
        return (
            <div className="flex items-center justify-center py-12">
                <div className="text-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-emerald-100 rounded-full flex items-center justify-center mx-auto mb-3 shadow-inner">
    ...
    return (
        ...
        scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
            ...
            hover:-translate-y-[1px] hover:shadow-md hover:ring-blue-200"
                    >
                        <div className="flex items-start gap-2.5">
                            <div className="w-7 h-7 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-lg
