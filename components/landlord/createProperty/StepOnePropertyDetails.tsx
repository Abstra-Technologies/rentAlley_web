...
export default function StepOneMerged() {
    ...
    // keep initial coords from property if available, otherwise null (map component can handle fallback)
    const [coords, setCoords] = useState<{ lat: number | null; lng: number | null }>({
        lat: (property as any)?.latitude ?? null,
        lng: (property as any)?.longitude ?? null,
    });

    const [addressQuery, setAddressQuery] = useState((property as any)?.street || "");
    ...
    const handleAddressSelect = (place: any) => {
        ...
        const parsed = {
            ...
            // ensure persistent coordinate keys used across component
    ...
    const getCurrentLocation = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            async (pos) => {
                ...
                try {
                    // Nominatim requires a User-Agent header — include minimal identifier
                    const res = await fetch(
    ...
    /* ---------------- Map Pin Handler ---------------- */
    // minimal handler that reverse geocodes the lat/lng and sets property fields
    const handleMapPinSelect = async (lat: number, lng: number) => {
        ...
        try {
            ...
            // still store lat/lng if reverse fails
...
- Location: ${p.street}, ${p.brgyDistrict}, ${p.city}, ${p.zipCode}, ${p.province}
        `;
        ...
        <div className="bg-white shadow-xl rounded-xl p-5 sm:p-8 lg:p-10 space-y-10 sm:space-y-12 text-[14px] sm:text-[15px]">
            ...
            <form className="space-y-10 sm:space-y-12">
                ...
                <div className="space-y-4">
                    ...
                    {/* Search box */}
                    <div>
                        <label className="text-sm font-semibold block mb-1.5">Street Address *</label>
                        <input
                            type="text"
                            name="street"
                            value={addressQuery}
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-lg p-4 space-y-3">
                        <h3 className="text-sm font-semibold text-gray-700">Choose how to set location:</h3>
                ...
                <div className="space-y-10 sm:space-y-12">
                    ...
                    {/* Floor Area */}
                    <div>
                        <label className="font-semibold text-sm">Total Property Size (sqm)</label>
                        <input
                            type="number"
                            name="floorArea"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                            {PROPERTY_PREFERENCES.map((pref) => {
                                ...
                                const isSelected = ((property as any).propertyPreferences || []).includes(pref.key);
                                return (
                                    <button
                                        key={pref.key}
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                <label className="text-sm font-semibold">Electricity Billing</label>
                                <select
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-gray-700 text-sm">
                                    {isDragActive ? "Drop photos here..." : "Drag or click to upload"}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <label className="text-sm font-semibold">Annual Rent Increase (%)</label>
