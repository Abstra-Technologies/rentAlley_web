...
import { HomeIcon, ClipboardDocumentListIcon, PencilSquareIcon, TrashIcon } from "@heroicons/react/24/outline";
                            ...
                            <div className="p-4">
                                ...
                                {billingMode && (
                                    <div className="mt-4 pt-4 border-t border-gray-200 space-y-2">
                                        ...
                                        <Link href={`/pages/landlord/billing/payments/${unit.unit_id}`}>
                                        ...
                                        {unitBillingStatus[unit.unit_id] ? (
                                            ...
                                            propertyDetails?.electricity_billing_type !== "submetered" ? (
                                                <Link href={`/pages/landlord/billing/viewUnitBill/${unit?.unit_id}`}>
