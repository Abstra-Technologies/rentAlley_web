...
export default function PropertyRatesModal({
    ...
    useEffect(() => {
        if (billingData) {
            // Automatically compute updated display rates
            setPropertyRate({
                electricityRate:
                    billingData?.electricity?.consumption > 0
                        ? billingData.electricity.total / billingData.electricity.consumption
                        : 0,
                waterRate:
                                ...
                                <input
                                    ...
                                    value={
                                        billingForm.billingPeriod
                                            ? new Date(billingForm.billingPeriod).toISOString().split("T")[0]
                                            : ""
                                    }
