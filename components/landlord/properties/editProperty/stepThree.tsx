        ...
        <div className="space-y-8">
            ...
            <div className="p-6 border rounded-md shadow-md">
                ...
                <div className="space-y-4">
                    ...
                    {/* 🔑 Separate Utility Billing Types */}
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-2 border rounded"
                        >
                            <option value="" disabled>Select water billing type</option>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-2 border rounded"
                        >
                            <option value="" disabled>Select electricity billing type</option>
                            {UTILITY_BILLING_TYPES.map((option) => (
                                <option key={option.value} value={option.value}>
                                    {option.label}
                                </option>
                        ...
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                            <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm">
                                ...
                                <ul className="space-y-2 text-gray-700">
                                    <li><strong>Included:</strong> Rent covers the utility.</li>
                                    <li><strong>Direct:</strong> Tenant pays the provider directly.</li>
                                    <li><strong>Submetered:</strong> Tenant is billed based on usage.</li>
                                </ul>
                                <button
