...
export default function InterestedTenants({ unitId, landlordId }) {
  ...
  /* =====================================================
     🔹 Fetch Landlord Subscription + Interested Tenants
     ===================================================== */
  useEffect(() => {
    let isMounted = true;
  ...
  const handleTenantClick = (tenant) => {
    ...
    router.push(
        `/pages/landlord/properties/${property_id}/units/details/${unitId}/prospectives/detailedInfo?unit_id=${unitId}&tenant_id=${tenant.tenant_id}`
    );
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:justify-between mb-8 gap-4 sm:gap-0">
            ...
            <div className="text-center sm:text-left lg:text-right space-y-2 sm:space-y-3">
              {/* Title */}
              ...
              {/* Description */}
              <p className="text-sm sm:text-base text-gray-600 max-w-md sm:max-w-none mx-auto sm:mx-0">
                These are tenants who have shown interest in your property and submitted their rental applications for your review.
              </p>

              {/* Property + Unit Info */}
              {propertyDetails && (
                  <div className="inline-flex flex-col sm:flex-row sm:items-center justify-center sm:justify-end gap-1 sm:gap-3 text-base sm:text-lg text-gray-700 pt-2">
