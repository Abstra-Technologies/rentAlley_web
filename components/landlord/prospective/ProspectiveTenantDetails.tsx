    ...
    const updateTenantStatus = async (newStatus) => {
        ...
        try {
            ...
            await Swal.fire({
                icon: "success",
                title: "Success!",
                text: `Tenant application status: ${newStatus} has been successfully sent to the applicant.`,
            ...
            if (newStatus === "approved") {
                router.push(
                    `/pages/landlord/property-listing/view-unit/${propertyId}/unit-details/${unitId}`
                );
            } else {
                router.back();
            }
            ...
            <div className="max-w-5xl mx-auto">
                <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                    <div className="relative bg-gray-100 overflow-hidden">
                        {unitPhotos && unitPhotos.length > 0 ? (
                            <div className="flex overflow-x-auto space-x-3 snap-x snap-mandatory scroll-smooth p-2">
                                {unitPhotos.map((photo, idx) => (
                                    <div
                                        key={idx}
                                        className="relative flex-shrink-0 w-80 h-48 rounded-lg overflow-hidden snap-center"
                                    >
                                        <Image
                                            src={photo}
