...
export default function PaymentSummaryCard({
    ...
    const [tenants, setTenants] = useState<
        { tenant_id: number; profilePicture: string | null; firstName: string; lastName: string }[]
    >([]);
                            ...
                            {tenants.map((t) => (
                                ...
                                >
                                    <img
                                        ...
                                        className="w-10 h-10 rounded-full object-cover border-2 border-gray-200 hover:border-blue-500 transition"
                                    />
                                </Link>
                            ))}
                        </div>
