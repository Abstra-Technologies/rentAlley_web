...
export default function PaymentSummaryCard({
                    ...
                    donut: {
                        ...
                        labels: {
                            ...
                            value: {
                                ...
                                color: "#374151",
                                formatter: () =>
                                    `₱${total.toLocaleString()}`, // ✅ ALWAYS SHOW ₱
                            },
                            total: {
                                show: true,
                                showAlways: true,
                                ...
                                color: "#6b7280",
                                formatter: () =>
                                    `₱${total.toLocaleString()}`, // ✅ ₱ even if 0
                            },
                        },
                    },
                },
    ...
    return (
      ...
      min-h-[420px] flex flex-col cursor-pointer select-none
          ...
          {currentMonth}
            ...
            <div className="flex justify-center my-6">
                {statsLoading ? (
                    ...
                    <Chart
                        options={options}
                        series={total > 0 ? series : [1]} // prevents Apex empty bug
                        type="donut"
                        width={180}
                        height={180}
                    />
...
function Stat({
    ...
    return (
      ...
      flex flex-col items-center shadow-inner`}
        >
