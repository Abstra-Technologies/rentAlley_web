...
import { Home, UserPlus, Megaphone, List } from "lucide-react";

export default function QuickActions({
                                         onAddProperty,
                                         onInviteTenant,
                                         onAnnouncement,
                                         onWorkOrder,  // 🔵 opens the modal
                                     }) {
    const actions = [
        {
            id: "addProperty",
        ...
        {
            id: "work_order",
            label: "New Work Order",    // 🔵 updated label
            icon: List,
            onClick: onWorkOrder,       // 🔵 opens the existing modal
        },
    ];
