  ...
  const desktopActions = [
    {
      ...
      hoverBg:
        "group-hover:bg-gradient-to-br group-hover:from-blue-500 group-hover:to-blue-600",
    },
    {
      id: "inviteTenant",
      label: "Invite Tenant",
      ...
      hoverBg:
        "group-hover:bg-gradient-to-br group-hover:from-emerald-500 group-hover:to-emerald-600",
    },
    {
      id: "announcement",
      label: "Announcement",
      ...
      hoverBg:
        "group-hover:bg-gradient-to-br group-hover:from-purple-500 group-hover:to-purple-600",
    },
    {
      id: "workOrder",
      label: "Work Order",
    ...
    },
    {
      ...
      hoverBg:
        "group-hover:bg-gradient-to-br group-hover:from-cyan-500 group-hover:to-cyan-600",
    },
  ];
