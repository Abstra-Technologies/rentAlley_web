      ...
      <div className="md:hidden overflow-x-auto flex gap-3 pb-2 snap-x snap-mandatory scrollbar-hide">
        {limitedProperties.map((property) => (
          <div
            ...
            className="snap-start min-w-[240px] bg-white rounded-lg border border-gray-200 overflow-hidden cursor-pointer hover:shadow-md transition-all flex-shrink-0"
          >
      ...
      <div className="hidden md:block space-y-2">
        {limitedProperties.map((property) => (
          <div
            ...
            className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 cursor-pointer transition-all"
          >
