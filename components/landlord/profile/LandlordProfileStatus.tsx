          ...
          <div className="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-xl p-3 sm:p-4 shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button className="mt-2 text-xs sm:text-sm font-medium text-red-700 underline hover:text-red-800">
                  View Details →
                </button>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 border border-gray-200 rounded-xl p-3 sm:p-4 shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button className="mt-2 text-xs sm:text-sm font-medium text-blue-600 underline hover:text-blue-700">
                  Complete Now →
                </button>
              </div>
            </div>
