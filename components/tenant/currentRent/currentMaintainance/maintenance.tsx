  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-emerald-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              >
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white rounded-xl font-semibold shadow-sm hover:shadow-md transition-all">
              ...
              >
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-white border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 text-gray-700 rounded-xl font-semibold transition-all shadow-sm">
        ...
        {/* Filter Tabs */}
        <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-200 p-5 mb-6">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-200 p-12 text-center">
            ...
            {filter === "all" && (
              ...
              >
                <button className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white rounded-xl font-semibold shadow-sm hover:shadow-md transition-all">
                  <PlusIcon className="w-5 h-5" />
                  Create Request
                </button>
              </Link>
          ...
          <div className="space-y-4">
            {filteredRequests.map((request) => (
              <div
                ...
                className="bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-200 hover:shadow-lg transition-all p-5 sm:p-6"
              >
