...
export default function TenantLeasePayments({
  ...
  if (loading) {
    return <LoadingScreen message="Fetching your payment history..." />;
  }
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 text-gray-700 rounded-xl transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
          >
            <ArrowPathIcon
          ...
          {!error && lease && payments.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                No payment records found for this lease agreement yet. Your payment history will appear here once you make your  payment.
              </p>
            </div>
          )}
          ...
          {!error && lease && payments.length > 0 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {/* Total Payments */}
                <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-200 p-6 hover:shadow-md transition-all">
                ...
                {/* Confirmed Payments */}
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl shadow-sm border-2 border-emerald-200 p-6 hover:shadow-md transition-all">
                  <div className="flex items-center gap-3 mb-3">
              ...
              {/* Desktop Table */}
              <div className="hidden lg:block bg-white rounded-2xl shadow-sm border-2 border-gray-200 overflow-hidden">
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-center">
                              <span
                                className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold ${getStatusBadge(
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-emerald-50 px-4 py-3 border-b border-gray-200">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold ${getStatusBadge(
                            payment.payment_status
                          )}`}
                        >
                          {getStatusIcon(payment.payment_status)}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 leading-relaxed">
                      This shows all payments made for your current lease agreement. 
                    </p>
                  </div>
                </div>
              </div>
