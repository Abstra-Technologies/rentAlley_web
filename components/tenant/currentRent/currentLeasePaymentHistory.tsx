    ...
    const fetchPayments = async () => {
        try {
            ...
            if (res.status === 200) {
                ...
                setLease(
                    leaseData && leaseData.agreement_id ? leaseData : null
                );
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50">
                <div className="bg-white border-b border-gray-200 pt-20 pb-4 px-4 md:px-8">
            ...
            <div className="bg-white border-b border-gray-200 pt-20 pb-4 px-4 md:px-8">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-xl border bg-white text-sm font-semibold"
                    >
                        <ArrowPathIcon
                        ...
                        <div className="bg-white rounded-xl border overflow-hidden">
                            <table className="w-full">
                                ...
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-left text-xs font-bold">Type</th>
                                    <th className="px-6 py-4 text-right text-xs font-bold">Amount</th>
                                    <th className="px-6 py-4 text-center text-xs font-bold">Status</th>
                                </tr>
                                </thead>
                                <tbody className="divide-y">
                                {payments.map((p) => (
                                    <tr key={p.payment_id} className="hover:bg-gray-50">
                                        <td className="px-6 py-4 font-mono text-sm">#{p.payment_id}</td>
