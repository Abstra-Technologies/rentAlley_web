...
const Page_footer = () => {
    ...
    const socialLinks = [
        { icon: FaFacebookF, href: "https://www.facebook.com/profile.php?id=61577142699570" },
        { icon: FaTwitter, href: "https://twitter.com/upkyp" },
        { icon: FaInstagram, href: "https://www.instagram.com/upkyp" },
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12">
                ...
                <div className="border-t border-white/20 mt-12 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
                        <p className="text-white/80 text-sm">© 2025 UpKyp. All rights reserved.</p>
